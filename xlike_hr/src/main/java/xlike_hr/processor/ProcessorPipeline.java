...
import xlike_hr.extractor.tools.DependenciesAnalyzer;
...
public class ProcessorPipeline {
	...
	private void configurePipelineFromTokens(ProcessingLevel target) {
		...
		case RELATIONS:
			...
			DependenciesAnalyzer dependenciesAnalyzer = new DependenciesAnalyzer();
			processors.add(dependenciesAnalyzer);
			break;
		default:
			break;
		}
